...
const REPOS = [
  ...
  { fullName: 'date-fns/date-fns', stars: 35000 },
  { fullName: 'colinhacks/zod', stars: 35000 },
  { fullName: 'pmndrs/zustand', stars: 50000 },
  { fullName: 'axios/axios', stars: 106000 },
];
...
function createAvatars(count: number): AvatarData[] {
  return Array.from({ length: count }, (_, i) => {
    ...
    return {
      dataUri: `https://github.com/${org}.png?size=128`,
...
const svg = renderMosaic(createAvatars(30), { dependentCount: 1280 });
